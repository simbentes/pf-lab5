...
export const requestPublicationBody = (id) => {
...
export const requestFromApi = (link_url) => {
    return new Promise ((fullfil, reject) => {
...
// example
const getHandle = () => {
    requestPublicationBody(1990981)
    .then(bodyArray => {
  ...
  const postHandle = () => {
    requestFromApi('https://www.publico.pt/api/list/ultimas')
    .then( json => {
